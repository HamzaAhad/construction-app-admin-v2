          ...
          {step === 0 ? (
            <div className="flex flex-col justify-start items-center space-x-4 w-full m-2">
              <label
                ...
                Your logo is the face of your company. Upload a clear,
                high-quality logo to showcase your brand&apos;s identity and
                make your business stand out to customers. A great logo builds
                trust and sets the tone for your brand. Let&rsquo;s make it
                memorable!
              </label>
